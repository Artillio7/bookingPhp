		...
		<div class="logo">
			...
			<nav>
				<ul>
					...
					<li><a href="booking.php">VOs_JEU</a></li>
				...
				<br><br>
					<div class="scroll">
						<?php
							...
							{
								$sql=$connect->query("INSERT INTO `comments` VALUES('','$_POST[comment]');");
								
								if($sql)
								{
									$q=$connect->query("SELECT * FROM `comments` ORDER BY `comments`.`id` DESC");
									//$q->execute(array());
							...
							else
							{
									...
									$q = $connect->prepare("SELECT * FROM `comments` ORDER BY `comments`.`id` DESC");
									$q->execute(array());
									echo "<table class='table table-bordered'>";
